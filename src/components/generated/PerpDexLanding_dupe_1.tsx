...
export const PerpDexLanding = (_props: PerpDexLandingProps) => {
  ...
  // @return
  return <div className="min-h-screen w-full bg-[#06171E] text-white font-['Inter'] overflow-x-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20">
        ...
        duration: 0.6
          ...
          marginBottom: "32px"
            ...
            Trade with <span className="text-[#15F46F]">100x Leverage</span>
          </h1>
        ...
        delay: 0.4
          ...
          <p className="text-white/60 text-sm sm:text-base mb-8 sm:mb-12 max-w-2xl mx-auto px-4">
