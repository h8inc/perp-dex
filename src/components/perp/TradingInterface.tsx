...
export const TradingInterface = () => {
  ...
  return <div className="flex flex-col h-screen w-full bg-[#0b0e11] text-white overflow-hidden font-sans selection:bg-[#00ff9d]/30">
      ...
      <div className="flex flex-1 overflow-hidden flex-col lg:flex-row">
        ...
        <div className="flex w-full lg:flex-[0.7] flex-col min-w-0">
          <ChartSection />
        ...
        <div className="hidden lg:block lg:flex-[0.3] lg:min-w-[360px] lg:max-w-[520px] border-l border-white/10 bg-[#0b0e11] overflow-y-auto">
